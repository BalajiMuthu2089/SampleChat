...
class LGChatMessageCell : UITableViewCell {
    ...
    struct Appearance {
        ...
        static var font: UIFont = UIFont.systemFontOfSize(19.0)
    }
    ...
    */
    ...
    private func styleTextViewForSentBy(sentBy: LGChatMessage.SentBy) {
        ...
        case .User:
          ...
          /*  if self.userImageView.image == nil {  // for UserImageView  - Balaji
                self.userImageView.hidden = false
                self.textView.center.x += CGRectGetWidth(self.userImageView.bounds) + self.padding
            }*/
...
class LGChatController : UIViewController, UITableViewDelegate, UITableViewDataSource, LGChatInputDelegate {
    ...
    */
    ...
    var userImage: UIImage?  //  for UserImageView - Balaji
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        //cell.userImageView.image = message.sentBy == .User ? self.userImage : nil //for UserImage-Balaji
...
class LGChatInput : UIView, LGStretchyTextViewDelegate {
    ...
    struct Appearance {
        ...
        static var textViewFont = UIFont.systemFontOfSize(19.0)  //changed
    ...
    */
    ...
    var textViewInsets = UIEdgeInsets(top: 5, left: 55, bottom: 5, right: 5)
    //var imageViewInsets = UIEdgeInsets(top: 5, left: 50, bottom: 5, right: 5)
    ...
    private let cameraButton = UIButton(type: .System)         // cameraButton - balaji
    private let blurredBackgroundView: UIToolbar = UIToolbar()
    private var heightConstraint: NSLayoutConstraint!
    private var sendButtonHeightConstraint: NSLayoutConstraint!
    private var cameraButtonHeightConstraint: NSLayoutConstraint!  // cameraButton - balaji
    ...
    func setupTextView() {
        ...
        self.addSubview(textView)
                             ...
                             // text label content for chatting
    func styleTextView() {
        ...
        textView.layer.borderColor = UIColor(white: 0.0, alpha: 0.2).CGColor
                              ...
                              // send button from chatcontroller
    func setupSendButton() {
        ...
        self.addSubview(sendButton)
                                           ...
                                           // constraints set for send button
    func setupSendButtonConstraints() {
        ...
        self.addConstraints([sendButtonHeightConstraint, widthConstraint, rightConstraint, bottomConstraint])
                                     ...
                                     // cameraButton setup - Balaji
    func setupcameraButton()
    {
        self.cameraButton.enabled = false
        self.cameraButton.setTitle("Camara", forState: .Normal)  // CAMERA BUTTON SET
        self.cameraButton.bounds = CGRect(x: 0, y: 0, width: 60, height: 1)
        self.addSubview(cameraButton)
    }
    func setupcameraButtonConstraint()
    {
        self.cameraButton.translatesAutoresizingMaskIntoConstraints = false
        self.cameraButton.removeConstraints(self.cameraButton.constraints)

        let leftConstraint = NSLayoutConstraint(item: self, attribute: .Left, relatedBy: .Equal, toItem: self.cameraButton, attribute: .Left, multiplier: 1.0, constant: textViewInsets.right)
        let bottomConstraint = NSLayoutConstraint(item: self, attribute: .Bottom, relatedBy: .Equal, toItem: self.cameraButton, attribute: .Bottom, multiplier: 1.0, constant: textViewInsets.bottom)
        let widthConstraint = NSLayoutConstraint(item: self.cameraButton, attribute: .Width, relatedBy: .Equal, toItem: nil, attribute: .NotAnAttribute, multiplier: 1.0, constant: 60)
        cameraButtonHeightConstraint = NSLayoutConstraint(item: self.cameraButton, attribute: .Height, relatedBy: .Equal, toItem: nil, attribute: .NotAnAttribute, multiplier: 1.0, constant: 30)
        self.addConstraints([cameraButtonHeightConstraint, widthConstraint, leftConstraint, bottomConstraint])
    }
    ...
    func stylize() {
        ...
        self.cameraButton.tintColor = Appearance.tintColor
    ...
    func stretchyTextViewDidChangeSize(textView: LGStretchyTextView) {
        ...
        if textView.text.characters.count == 0 {
            ...
            //self.cameraButtonHeightConstraint.constant = textViewHeight
        }
